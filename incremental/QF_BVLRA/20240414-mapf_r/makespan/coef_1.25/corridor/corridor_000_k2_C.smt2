...
(assert (or (<= (+ A0.atime<1> (+ A0.wtime<1> (+ (* (- 1) A1.atime<3>) (* (- 1) A1.wtime<3>)))) 0) (or (<= 1 (+ A0.atime<1> (+ (* (- 1) A1.atime<3>) (* (- 1) A1.wtime<3>)))) (or (or (not (= A0.V<1> (_ bv1 16))) (not (= A1.V<3> (_ bv1 16)))) (not (= A1.V<4> (_ bv2 16)))))))
(set-info :status sat)
(check-sat)
