...
(assert (or (<= (+ A0.atime<2> (+ A0.wtime<2> (+ (* (- 1) A1.atime<2>) (* (- 1) A1.wtime<2>)))) 0) (or (<= 1 (+ A0.atime<2> (+ (* (- 1) A1.atime<2>) (* (- 1) A1.wtime<2>)))) (or (not (= A1.V<3> (_ bv0 16))) (or (not (= A0.V<2> (_ bv0 16))) (not (= A1.V<2> (_ bv2 16))))))))
