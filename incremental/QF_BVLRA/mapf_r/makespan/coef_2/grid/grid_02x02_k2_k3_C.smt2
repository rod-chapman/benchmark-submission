...
(assert (let ((.def_425 (ite (<= A2.atime<2> 0) 0 A2.atime<2>))) (let ((.def_427 (ite (<= A1.atime<2> .def_425) .def_425 A1.atime<2>))) (= objtime (ite (<= A0.atime<2> .def_427) .def_427 A0.atime<2>)))))
(set-info :status sat)
(check-sat)
